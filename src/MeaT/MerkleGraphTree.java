...
public class MerkleGraphTree {
    ...
    // Child trees
    private MeaT.MerkleGraphTree leftTree = null;
    private MeaT.MerkleGraphTree rightTree = null;

    // Child leaves
    private GraphLeaf leftLeaf = null;
    private GraphLeaf rightLeaf = null;
     ...
     *
     * graphleaf The graph leaf node
     *
     * @return The digest generated from the leaf
     */
    private byte[] digest(GraphLeaf graphLeaf)
    {
        final List<Edge> dataBlock = graphLeaf.getEdges();
     ...
     */
    public MerkleGraphTree(MessageDigest md)
    {
        this.md = md;
    }
     ...
     */
    public void add(final MeaT.MerkleGraphTree leftTree, final MeaT.MerkleGraphTree rightTree)
    {
     ...
     */
    public void add(final GraphLeaf leftLeaf, final GraphLeaf rightLeaf)
    {
     ...
     */
    public MeaT.MerkleGraphTree leftTree()
    {
        return (leftTree);
    }
     ...
     */
    public MeaT.MerkleGraphTree rightTree()
    {
        return (rightTree);
    }
